...
// SCB (para configurar PRIGROUP en AIRCR)
...
void nvic_set_priority(uint32_t IRQn, uint8_t prio); // 0 = más alta
void nvic_set_grouping(uint32_t prigroup);           // p. ej. 5 = 4 bits preempt
